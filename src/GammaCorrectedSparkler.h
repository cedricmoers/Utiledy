...
#define _GAMMACORRECTEDSPARKLER_h
...
class GammaCorrectedSparkler : public virtual GammaCorrectedFader
{
public:

	//Main constructor
	GammaCorrectedSparkler(char* identificator,
		uint8_t ledPin,
